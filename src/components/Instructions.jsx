  ...
  return (
    <section className="inst">
      ...
      <ol className="inst__list">
        ...
        <li>
          <span className="inst__bold"> Heat the pan: </span>5 Place a non-stick
          frying pan over medium heat and add butter or oil.
        </li>
        <li>
          <span className="inst__bold">Cook the omelette: </span>Once the butter
        ...
        <li>
          <span className="inst__bold">Enjoy: </span>Serve hot, with additional
